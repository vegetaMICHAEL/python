# 卷积神经⽹络：
# ⼀卷积层：卷积：32个filter, 5*5，strides1, padding=“SAME”
# 输⼊：[None, 28, 28, 1] 输出：[None, 28,28, 32]
# 激活:[None, 28,28, 32]
# 池化：2*2 ,strides2, padding=“SAME”
# [None, 28, 28, 32]———>[None, 14, 14, 32]
# bias=32
# ⼆卷积层：卷积:64个filter，5*5，strides1,padding=“SAME”
# 输⼊：[None, 14, 14, 32] 输出：[None, 14, 14, 64]
#  激活:[None, 14, 14, 64]
# 池化:2*2， strides2
# 输⼊：[None, 14, 14, 64] 输出：[None, 7, 7, 64]
# bias=64
# 全连接层FC：
